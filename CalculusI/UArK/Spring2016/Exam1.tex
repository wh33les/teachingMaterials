...
\newcommand{\class}{Math 2554 (Calculus I)}
\newcommand{\term}{Spring 2016}
\newcommand{\examnum}{Exam 1}
\newcommand{\examdate}{Fri 12 Feb 2016}
...
%\textbf{\term} &&\\
\textbf{\Huge\examnum: Limits (\S 2.1-3.1)} &&\\
%\textbf{\examdate} &&\\
\textbf{Time Limit: \timelimit} & Drill Instructor & \makebox[2in]{\hrulefill}
\end{tabular}\\
\end{flushright}
