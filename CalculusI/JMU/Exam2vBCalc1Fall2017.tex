...
\coverrunningheader{}
	{Exam 2vB: Derivatives, with story problems}
	{}
...
%\vspace{-0.5pc}
	\begin{parts}
	\part[4] Find the average rate of change of $f$ on the interval %$[20,60]$
	$[0,40]$
	.
	\vfill
	...
	\part[4] Which interval gives a larger average rate of change, %$[40,60]$ 
	$[0,40]$  
	or %$[40,70]$
	$[10,40]$?  How can you tell?
	\vfill
	
	\part[4] Compute %$\frac{f(40)-f(10)}{40-10}$
	$\frac{f(50)-f(20)}{50-20}$; what does this value represent geometrically?
	\end{parts}
...
\begin{parts}
	...
	\part[10] A freshly brewed cup of coffee has temperature %95
	105$^{\circ}$C in a %20
	30$^{\circ}$C room.  When its temperature is %70
	80$^{\circ}$C, it is cooling at a rate of 1$^{\circ}$C per minute.  When does this occur?  \textit{Hint: To solve for $k$, you must write your answer to part (a) in terms of $T(t)$.  If you don't, then you will have an equation that cannot be solved by hand.}
